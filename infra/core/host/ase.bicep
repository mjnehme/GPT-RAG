...
module subnet 'ase-subnet.bicep' = if (useExistingVnetandSubnet) {
...
module privatednszone 'ase-privatedns.bicep' = if (createPrivateDNS && internalLoadBalancingMode == 3) {
...
/*
  LEER:
      * MAIN.BICEP Esta definido AppServicePlan en linea 436

      https://github.com/Azure/azure-quickstart-templates/blob/master/quickstarts/microsoft.web/web-app-asp-app-on-asev3-create/main.bicep
      https://github.com/Azure/ResourceModules/tree/main/modules/web/hosting-environment#Outputs
      https://medium.com/rwiankowski/azure-app-service-environment-v3-f29dd991df9b
      https://learn.microsoft.com/en-us/azure/templates/microsoft.web/serverfarms?pivots=deployment-language-bicep#hostingenvironmentprofile
*/
